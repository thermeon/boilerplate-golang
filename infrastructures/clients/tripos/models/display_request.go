...
// Validate validates this display request
func (m *DisplayRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DisplayRequest) validateLaneID(formats strfmt.Registry) error {
...
// ContextValidate validates this display request based on context it is used
func (m *DisplayRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *DisplayRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DisplayRequest) UnmarshalBinary(b []byte) error {
	var res DisplayRequest
