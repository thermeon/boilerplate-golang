...
// BalanceTransferGiftRequest BalanceTransferGiftRequest
//
// swagger:model BalanceTransferGiftRequest
type BalanceTransferGiftRequest struct {
...
// Validate validates this balance transfer gift request
func (m *BalanceTransferGiftRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BalanceTransferGiftRequest) validateAlternateCardNumber1(formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftRequest) validateConfiguration(formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftRequest) validateLaneID(formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftRequest) validateStoreCard(formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftRequest) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this balance transfer gift request based on the context it is used
func (m *BalanceTransferGiftRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BalanceTransferGiftRequest) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftRequest) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BalanceTransferGiftRequest) UnmarshalBinary(b []byte) error {
	var res BalanceTransferGiftRequest
