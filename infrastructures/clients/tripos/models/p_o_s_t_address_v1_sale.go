...
// POSTAddressV1Sale Address
//
// swagger:model POST_Address_v1_sale
type POSTAddressV1Sale struct {
...
// Validate validates this p o s t address v1 sale
func (m *POSTAddressV1Sale) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 sale based on context it is used
func (m *POSTAddressV1Sale) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1Sale) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1Sale) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1Sale
