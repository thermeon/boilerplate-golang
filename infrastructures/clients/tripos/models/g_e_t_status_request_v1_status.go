...
// GETStatusRequestV1Status StatusRequest
//
// swagger:model GET_StatusRequest_v1_status
type GETStatusRequestV1Status struct {
...
// Validate validates this g e t status request v1 status
func (m *GETStatusRequestV1Status) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GETStatusRequestV1Status) validateAcceptorID(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateAccountID(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateAccountToken(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateApplicationID(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateApplicationName(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateApplicationVersion(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateAuthorizationSignature(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateCtafObject(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateLaneLock(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateRequestID(formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) validateRequestIDAsGUID(formats strfmt.Registry) error {
...
// ContextValidate validate this g e t status request v1 status based on the context it is used
func (m *GETStatusRequestV1Status) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GETStatusRequestV1Status) contextValidateLaneLock(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GETStatusRequestV1Status) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GETStatusRequestV1Status) UnmarshalBinary(b []byte) error {
	var res GETStatusRequestV1Status
