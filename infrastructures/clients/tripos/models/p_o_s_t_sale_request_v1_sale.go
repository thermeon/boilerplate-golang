...
// POSTSaleRequestV1Sale SaleRequest
//
// swagger:model POST_SaleRequest_v1_sale
type POSTSaleRequestV1Sale struct {
...
// Validate validates this p o s t sale request v1 sale
func (m *POSTSaleRequestV1Sale) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTSaleRequestV1Sale) validateAddress(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) validateAutoRental(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) validateHealthcare(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) validateLodging(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) validateStoreCard(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t sale request v1 sale based on the context it is used
func (m *POSTSaleRequestV1Sale) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTSaleRequestV1Sale) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) contextValidateAutoRental(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) contextValidateHealthcare(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) contextValidateLodging(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestV1Sale) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTSaleRequestV1Sale) UnmarshalBinary(b []byte) error {
	var res POSTSaleRequestV1Sale
