...
// POSTHealthcareV1Sale Healthcare
//
// swagger:model POST_Healthcare_v1_sale
type POSTHealthcareV1Sale struct {
...
// Validate validates this p o s t healthcare v1 sale
func (m *POSTHealthcareV1Sale) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t healthcare v1 sale based on context it is used
func (m *POSTHealthcareV1Sale) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTHealthcareV1Sale) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTHealthcareV1Sale) UnmarshalBinary(b []byte) error {
	var res POSTHealthcareV1Sale
