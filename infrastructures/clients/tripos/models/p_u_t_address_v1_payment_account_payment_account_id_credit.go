...
// PUTAddressV1PaymentAccountPaymentAccountIDCredit Address
//
// swagger:model PUT_Address_v1_paymentAccount_paymentAccountId_credit
type PUTAddressV1PaymentAccountPaymentAccountIDCredit struct {
...
// Validate validates this p u t address v1 payment account payment account Id credit
func (m *PUTAddressV1PaymentAccountPaymentAccountIDCredit) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p u t address v1 payment account payment account Id credit based on context it is used
func (m *PUTAddressV1PaymentAccountPaymentAccountIDCredit) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PUTAddressV1PaymentAccountPaymentAccountIDCredit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PUTAddressV1PaymentAccountPaymentAccountIDCredit) UnmarshalBinary(b []byte) error {
	var res PUTAddressV1PaymentAccountPaymentAccountIDCredit
