...
//
// swagger:model GetServicesResponse
...
// Validate validates this get services response
func (m *GetServicesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetServicesResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GetServicesResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *GetServicesResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this get services response based on the context it is used
func (m *GetServicesResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetServicesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetServicesResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetServicesResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetServicesResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetServicesResponse) UnmarshalBinary(b []byte) error {
	var res GetServicesResponse
