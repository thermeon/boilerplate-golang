...
// POSTAddressV1SaleTransactionIDReturnPaymentType Address
//
// swagger:model POST_Address_v1_sale_transactionId_return_paymentType
type POSTAddressV1SaleTransactionIDReturnPaymentType struct {
...
// Validate validates this p o s t address v1 sale transaction Id return payment type
func (m *POSTAddressV1SaleTransactionIDReturnPaymentType) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 sale transaction Id return payment type based on context it is used
func (m *POSTAddressV1SaleTransactionIDReturnPaymentType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1SaleTransactionIDReturnPaymentType) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1SaleTransactionIDReturnPaymentType) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1SaleTransactionIDReturnPaymentType
