...
// PUTAddressV1PaymentAccountPaymentAccountID Address
//
// swagger:model PUT_Address_v1_paymentAccount_paymentAccountId
type PUTAddressV1PaymentAccountPaymentAccountID struct {
...
// Validate validates this p u t address v1 payment account payment account Id
func (m *PUTAddressV1PaymentAccountPaymentAccountID) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p u t address v1 payment account payment account Id based on context it is used
func (m *PUTAddressV1PaymentAccountPaymentAccountID) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PUTAddressV1PaymentAccountPaymentAccountID) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PUTAddressV1PaymentAccountPaymentAccountID) UnmarshalBinary(b []byte) error {
	var res PUTAddressV1PaymentAccountPaymentAccountID
