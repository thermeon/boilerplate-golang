...
// CreateOmniTokenResponse CreateOmniTokenResponse
//
// swagger:model CreateOmniTokenResponse
type CreateOmniTokenResponse struct {
	...
	// The card bin value. This value is only provided for a CreateOmniTokenRequest NOT for a CreateOmniTokenWithTransIdRequest.
	BinValue string `json:"binValue,omitempty"`

	// The card holder name on the card. This value is only provided for a CreateOmniTokenRequest NOT for a CreateOmniTokenWithTransIdRequest. If the card is keyed for a CreateOmniTokenRequest this value will be empty.
	...
	// Description of how card was entered. This value is only provided for a CreateOmniTokenRequest NOT for a CreateOmniTokenWithTransIdRequest.
...
// Validate validates this create omni token response
func (m *CreateOmniTokenResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateOmniTokenResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CreateOmniTokenResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *CreateOmniTokenResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *CreateOmniTokenResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this create omni token response based on the context it is used
func (m *CreateOmniTokenResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CreateOmniTokenResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateOmniTokenResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateOmniTokenResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateOmniTokenResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateOmniTokenResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateOmniTokenResponse) UnmarshalBinary(b []byte) error {
	var res CreateOmniTokenResponse
