...
// POSTAddressV1PaymentAccountCredit Address
//
// swagger:model POST_Address_v1_paymentAccount_credit
type POSTAddressV1PaymentAccountCredit struct {
...
// Validate validates this p o s t address v1 payment account credit
func (m *POSTAddressV1PaymentAccountCredit) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 payment account credit based on context it is used
func (m *POSTAddressV1PaymentAccountCredit) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1PaymentAccountCredit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1PaymentAccountCredit) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1PaymentAccountCredit
