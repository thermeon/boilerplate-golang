...
// UnloadGiftResponse UnloadGiftResponse
//
// swagger:model UnloadGiftResponse
type UnloadGiftResponse struct {
...
// Validate validates this unload gift response
func (m *UnloadGiftResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UnloadGiftResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *UnloadGiftResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *UnloadGiftResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *UnloadGiftResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this unload gift response based on the context it is used
func (m *UnloadGiftResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UnloadGiftResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnloadGiftResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnloadGiftResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnloadGiftResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnloadGiftResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UnloadGiftResponse) UnmarshalBinary(b []byte) error {
	var res UnloadGiftResponse
