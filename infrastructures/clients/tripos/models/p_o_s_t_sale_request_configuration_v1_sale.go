...
// POSTSaleRequestConfigurationV1Sale SaleRequestConfiguration
//
// swagger:model POST_SaleRequestConfiguration_v1_sale
type POSTSaleRequestConfigurationV1Sale struct {
...
// Validate validates this p o s t sale request configuration v1 sale
func (m *POSTSaleRequestConfigurationV1Sale) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTSaleRequestConfigurationV1Sale) validateCashbackOptions(formats strfmt.Registry) error {
...
func (m *POSTSaleRequestConfigurationV1Sale) validateTipOptions(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t sale request configuration v1 sale based on the context it is used
func (m *POSTSaleRequestConfigurationV1Sale) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTSaleRequestConfigurationV1Sale) contextValidateCashbackOptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestConfigurationV1Sale) contextValidateTipOptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTSaleRequestConfigurationV1Sale) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTSaleRequestConfigurationV1Sale) UnmarshalBinary(b []byte) error {
	var res POSTSaleRequestConfigurationV1Sale
