...
// POSTReceiptEmvDtoV1Receipt ReceiptEmvDto
//
// swagger:model POST_ReceiptEmvDto_v1_receipt
type POSTReceiptEmvDtoV1Receipt struct {
...
// Validate validates this p o s t receipt emv dto v1 receipt
func (m *POSTReceiptEmvDtoV1Receipt) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTReceiptEmvDtoV1Receipt) validateApplicationIdentifier(formats strfmt.Registry) error {
...
func (m *POSTReceiptEmvDtoV1Receipt) validateApplicationLabel(formats strfmt.Registry) error {
...
func (m *POSTReceiptEmvDtoV1Receipt) validateApplicationPreferredName(formats strfmt.Registry) error {
...
func (m *POSTReceiptEmvDtoV1Receipt) validateCryptogram(formats strfmt.Registry) error {
...
func (m *POSTReceiptEmvDtoV1Receipt) validateIssuerCodeTableIndex(formats strfmt.Registry) error {
...
func (m *POSTReceiptEmvDtoV1Receipt) validateTags(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t receipt emv dto v1 receipt based on the context it is used
func (m *POSTReceiptEmvDtoV1Receipt) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTReceiptEmvDtoV1Receipt) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTReceiptEmvDtoV1Receipt) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTReceiptEmvDtoV1Receipt) UnmarshalBinary(b []byte) error {
	var res POSTReceiptEmvDtoV1Receipt
