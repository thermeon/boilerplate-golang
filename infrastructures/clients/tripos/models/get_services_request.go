...
//
// swagger:model GetServicesRequest
...
// Validate validates this get services request
func (m *GetServicesRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetServicesRequest) validateAcceptorID(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateAccountID(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateAccountToken(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateApplicationID(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateApplicationName(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateApplicationVersion(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateAuthorizationSignature(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateCtafObject(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateLaneLock(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateRequestID(formats strfmt.Registry) error {
...
func (m *GetServicesRequest) validateRequestIDAsGUID(formats strfmt.Registry) error {
...
// ContextValidate validate this get services request based on the context it is used
func (m *GetServicesRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetServicesRequest) contextValidateLaneLock(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetServicesRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetServicesRequest) UnmarshalBinary(b []byte) error {
	var res GetServicesRequest
