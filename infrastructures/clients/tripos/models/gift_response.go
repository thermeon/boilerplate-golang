...
// Validate validates this gift response
func (m *GiftResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GiftResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *GiftResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *GiftResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this gift response based on the context it is used
func (m *GiftResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GiftResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GiftResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GiftResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GiftResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GiftResponse) UnmarshalBinary(b []byte) error {
	var res GiftResponse
