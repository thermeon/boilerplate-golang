...
// POSTAddressV1AuthorizationPaymentAccountID Address
//
// swagger:model POST_Address_v1_authorization_paymentAccountId
type POSTAddressV1AuthorizationPaymentAccountID struct {
...
// Validate validates this p o s t address v1 authorization payment account Id
func (m *POSTAddressV1AuthorizationPaymentAccountID) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 authorization payment account Id based on context it is used
func (m *POSTAddressV1AuthorizationPaymentAccountID) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1AuthorizationPaymentAccountID) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1AuthorizationPaymentAccountID) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1AuthorizationPaymentAccountID
