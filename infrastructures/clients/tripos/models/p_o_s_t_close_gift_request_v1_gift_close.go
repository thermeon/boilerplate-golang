...
// POSTCloseGiftRequestV1GiftClose CloseGiftRequest
//
// swagger:model POST_CloseGiftRequest_v1_gift_close
type POSTCloseGiftRequestV1GiftClose struct {
	...
	Configuration *POSTRequestConfigurationV1GiftClose `json:"configuration,omitempty"`
	...
	StoreCard *POSTStoreCardV1GiftClose `json:"storeCard,omitempty"`
...
// Validate validates this p o s t close gift request v1 gift close
func (m *POSTCloseGiftRequestV1GiftClose) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTCloseGiftRequestV1GiftClose) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTCloseGiftRequestV1GiftClose) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTCloseGiftRequestV1GiftClose) validateStoreCard(formats strfmt.Registry) error {
...
func (m *POSTCloseGiftRequestV1GiftClose) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t close gift request v1 gift close based on the context it is used
func (m *POSTCloseGiftRequestV1GiftClose) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTCloseGiftRequestV1GiftClose) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTCloseGiftRequestV1GiftClose) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTCloseGiftRequestV1GiftClose) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTCloseGiftRequestV1GiftClose) UnmarshalBinary(b []byte) error {
	var res POSTCloseGiftRequestV1GiftClose
