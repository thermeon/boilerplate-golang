...
type RefundResponse struct {
	...
	// Indicates whether the Credit card Refund transaction converted to a PINless Debit Card transaction.
...
// Validate validates this refund response
func (m *RefundResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RefundResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *RefundResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *RefundResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *RefundResponse) validateWarnings(formats strfmt.Registry) error {
...
func (m *RefundResponse) validateEmv(formats strfmt.Registry) error {
...
func (m *RefundResponse) validateSignature(formats strfmt.Registry) error {
...
// ContextValidate validate this refund response based on the context it is used
func (m *RefundResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RefundResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RefundResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RefundResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RefundResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RefundResponse) contextValidateEmv(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RefundResponse) contextValidateSignature(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RefundResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RefundResponse) UnmarshalBinary(b []byte) error {
