...
// PaymentAccountSaleResponse PaymentAccountSaleResponse
//
// swagger:model PaymentAccountSaleResponse
type PaymentAccountSaleResponse struct {
...
// Validate validates this payment account sale response
func (m *PaymentAccountSaleResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentAccountSaleResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *PaymentAccountSaleResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *PaymentAccountSaleResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *PaymentAccountSaleResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this payment account sale response based on the context it is used
func (m *PaymentAccountSaleResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentAccountSaleResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PaymentAccountSaleResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PaymentAccountSaleResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PaymentAccountSaleResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PaymentAccountSaleResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PaymentAccountSaleResponse) UnmarshalBinary(b []byte) error {
	var res PaymentAccountSaleResponse
