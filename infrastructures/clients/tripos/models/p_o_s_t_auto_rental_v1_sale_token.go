...
// POSTAutoRentalV1SaleToken AutoRental
//
// swagger:model POST_AutoRental_v1_sale_token
type POSTAutoRentalV1SaleToken struct {

	// Data related to any auto rental adjustments.
	AdjustmentData *POSTAutoRentalAdjustmentDataV1SaleToken `json:"adjustmentData,omitempty"`
	...
	PickupData *POSTAutoRentalPickupDataV1SaleToken `json:"pickupData,omitempty"`

	// Data related to autorental return.
	ReturnData *POSTAutoRentalReturnDataV1SaleToken `json:"returnData,omitempty"`
...
// Validate validates this p o s t auto rental v1 sale token
func (m *POSTAutoRentalV1SaleToken) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTAutoRentalV1SaleToken) validateAdjustmentData(formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1SaleToken) validatePickupData(formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1SaleToken) validateReturnData(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t auto rental v1 sale token based on the context it is used
func (m *POSTAutoRentalV1SaleToken) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTAutoRentalV1SaleToken) contextValidateAdjustmentData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1SaleToken) contextValidatePickupData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1SaleToken) contextValidateReturnData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1SaleToken) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAutoRentalV1SaleToken) UnmarshalBinary(b []byte) error {
	var res POSTAutoRentalV1SaleToken
