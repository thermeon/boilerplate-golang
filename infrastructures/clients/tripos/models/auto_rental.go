...
// Validate validates this auto rental
func (m *AutoRental) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AutoRental) validateAdjustmentData(formats strfmt.Registry) error {
...
func (m *AutoRental) validatePickupData(formats strfmt.Registry) error {
...
func (m *AutoRental) validateReturnData(formats strfmt.Registry) error {
...
// ContextValidate validate this auto rental based on the context it is used
func (m *AutoRental) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AutoRental) contextValidateAdjustmentData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AutoRental) contextValidatePickupData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AutoRental) contextValidateReturnData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AutoRental) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AutoRental) UnmarshalBinary(b []byte) error {
	var res AutoRental
