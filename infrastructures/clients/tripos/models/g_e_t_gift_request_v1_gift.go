...
// GETGiftRequestV1Gift GiftRequest
//
// swagger:model GET_GiftRequest_v1_gift
type GETGiftRequestV1Gift struct {
	...
	// lane lock
	// Required: true
	LaneLock *GETILaneLockV1Gift `json:"laneLock"`
	...
	// request Id as Guid
	// Required: true
	RequestIDAsGUID GETGUIDV1Gift `json:"requestIdAsGuid"`

	// Set to true to have logs populated in the response.
	ReturnLogs bool `json:"returnLogs,omitempty"`
}

// Validate validates this g e t gift request v1 gift
func (m *GETGiftRequestV1Gift) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GETGiftRequestV1Gift) validateAcceptorID(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateAccountID(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateAccountToken(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateApplicationID(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateApplicationName(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateApplicationVersion(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateAuthorizationSignature(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateCtafObject(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateLaneLock(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateRequestID(formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) validateRequestIDAsGUID(formats strfmt.Registry) error {
...
// ContextValidate validate this g e t gift request v1 gift based on the context it is used
func (m *GETGiftRequestV1Gift) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GETGiftRequestV1Gift) contextValidateLaneLock(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GETGiftRequestV1Gift) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GETGiftRequestV1Gift) UnmarshalBinary(b []byte) error {
	var res GETGiftRequestV1Gift
