...
// TokenRefundResponse TokenRefundResponse
//
// swagger:model TokenRefundResponse
type TokenRefundResponse struct {
...
// Validate validates this token refund response
func (m *TokenRefundResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TokenRefundResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *TokenRefundResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *TokenRefundResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *TokenRefundResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this token refund response based on the context it is used
func (m *TokenRefundResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TokenRefundResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenRefundResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenRefundResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenRefundResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenRefundResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TokenRefundResponse) UnmarshalBinary(b []byte) error {
	var res TokenRefundResponse
