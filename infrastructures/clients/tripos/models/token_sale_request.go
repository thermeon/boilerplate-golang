...
// TokenSaleRequest TokenSaleRequest
//
// swagger:model TokenSaleRequest
...
// Validate validates this token sale request
func (m *TokenSaleRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TokenSaleRequest) validateAddress(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateAutoRental(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateCardLogo(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateConfiguration(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateHealthcare(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateLaneID(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateTokenID(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateTokenProvider(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateTransactionAmount(formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) validateVaultID(formats strfmt.Registry) error {
...
// ContextValidate validate this token sale request based on the context it is used
func (m *TokenSaleRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TokenSaleRequest) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) contextValidateAutoRental(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) contextValidateHealthcare(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TokenSaleRequest) UnmarshalBinary(b []byte) error {
	var res TokenSaleRequest
