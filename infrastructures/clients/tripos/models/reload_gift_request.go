...
// ReloadGiftRequest ReloadGiftRequest
//
// swagger:model ReloadGiftRequest
type ReloadGiftRequest struct {
...
// Validate validates this reload gift request
func (m *ReloadGiftRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReloadGiftRequest) validateConfiguration(formats strfmt.Registry) error {
...
func (m *ReloadGiftRequest) validateLaneID(formats strfmt.Registry) error {
...
func (m *ReloadGiftRequest) validateStoreCard(formats strfmt.Registry) error {
...
func (m *ReloadGiftRequest) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this reload gift request based on the context it is used
func (m *ReloadGiftRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReloadGiftRequest) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReloadGiftRequest) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReloadGiftRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ReloadGiftRequest) UnmarshalBinary(b []byte) error {
	var res ReloadGiftRequest
