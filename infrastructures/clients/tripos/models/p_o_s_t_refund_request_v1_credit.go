...
// POSTRefundRequestV1Credit RefundRequest
//
// swagger:model POST_RefundRequest_v1_credit
type POSTRefundRequestV1Credit struct {

	// The cardholder address information for the transaction.
	Address *POSTAddressV1Credit `json:"address,omitempty"`
	...
	Configuration *POSTRefundRequestConfigurationV1Credit `json:"configuration,omitempty"`
	...
	StoreCard *POSTStoreCardV1Credit `json:"storeCard,omitempty"`
...
// Validate validates this p o s t refund request v1 credit
func (m *POSTRefundRequestV1Credit) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTRefundRequestV1Credit) validateAddress(formats strfmt.Registry) error {
...
func (m *POSTRefundRequestV1Credit) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTRefundRequestV1Credit) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTRefundRequestV1Credit) validateStoreCard(formats strfmt.Registry) error {
...
func (m *POSTRefundRequestV1Credit) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t refund request v1 credit based on the context it is used
func (m *POSTRefundRequestV1Credit) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTRefundRequestV1Credit) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTRefundRequestV1Credit) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTRefundRequestV1Credit) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTRefundRequestV1Credit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTRefundRequestV1Credit) UnmarshalBinary(b []byte) error {
	var res POSTRefundRequestV1Credit
