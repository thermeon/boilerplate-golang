...
// POSTForceCreditRequestV1ForceCredit ForceCreditRequest
//
// swagger:model POST_ForceCreditRequest_v1_force_credit
type POSTForceCreditRequestV1ForceCredit struct {
...
// Validate validates this p o s t force credit request v1 force credit
func (m *POSTForceCreditRequestV1ForceCredit) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTForceCreditRequestV1ForceCredit) validateAddress(formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) validateApprovalNumber(formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) validateAutoRental(formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) validateLodging(formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t force credit request v1 force credit based on the context it is used
func (m *POSTForceCreditRequestV1ForceCredit) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTForceCreditRequestV1ForceCredit) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) contextValidateAutoRental(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) contextValidateLodging(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTForceCreditRequestV1ForceCredit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTForceCreditRequestV1ForceCredit) UnmarshalBinary(b []byte) error {
	var res POSTForceCreditRequestV1ForceCredit
