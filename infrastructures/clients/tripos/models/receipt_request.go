...
// Validate validates this receipt request
func (m *ReceiptRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReceiptRequest) validateAccountNumber(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateCardLogo(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateEmv(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateEntryMode(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateIsApproved(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateLaneID(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateMerchantID(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateReferenceNumber(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateSubTotalAmount(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateTerminalID(formats strfmt.Registry) error {
...
func (m *ReceiptRequest) validateTransactionDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this receipt request based on the context it is used
func (m *ReceiptRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReceiptRequest) contextValidateEmv(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReceiptRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ReceiptRequest) UnmarshalBinary(b []byte) error {
	var res ReceiptRequest
