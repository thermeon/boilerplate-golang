...
// Validate validates this idle response
func (m *IdleResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IdleResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *IdleResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *IdleResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this idle response based on the context it is used
func (m *IdleResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IdleResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IdleResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IdleResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IdleResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IdleResponse) UnmarshalBinary(b []byte) error {
	var res IdleResponse
