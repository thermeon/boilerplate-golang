...
// POSTAddressV1ForceCredit Address
//
// swagger:model POST_Address_v1_force_credit
type POSTAddressV1ForceCredit struct {
...
// Validate validates this p o s t address v1 force credit
func (m *POSTAddressV1ForceCredit) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 force credit based on context it is used
func (m *POSTAddressV1ForceCredit) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1ForceCredit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1ForceCredit) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1ForceCredit
