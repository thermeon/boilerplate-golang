...
// POSTAddressV1PaymentAccount Address
//
// swagger:model POST_Address_v1_paymentAccount
type POSTAddressV1PaymentAccount struct {
...
// Validate validates this p o s t address v1 payment account
func (m *POSTAddressV1PaymentAccount) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 payment account based on context it is used
func (m *POSTAddressV1PaymentAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1PaymentAccount) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1PaymentAccount) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1PaymentAccount
