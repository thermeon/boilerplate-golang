...
// POSTAutoRentalV1Sale AutoRental
//
// swagger:model POST_AutoRental_v1_sale
type POSTAutoRentalV1Sale struct {

	// Data related to any auto rental adjustments.
	AdjustmentData *POSTAutoRentalAdjustmentDataV1Sale `json:"adjustmentData,omitempty"`
	...
	PickupData *POSTAutoRentalPickupDataV1Sale `json:"pickupData,omitempty"`

	// Data related to autorental return.
	ReturnData *POSTAutoRentalReturnDataV1Sale `json:"returnData,omitempty"`
...
// Validate validates this p o s t auto rental v1 sale
func (m *POSTAutoRentalV1Sale) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTAutoRentalV1Sale) validateAdjustmentData(formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1Sale) validatePickupData(formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1Sale) validateReturnData(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t auto rental v1 sale based on the context it is used
func (m *POSTAutoRentalV1Sale) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTAutoRentalV1Sale) contextValidateAdjustmentData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1Sale) contextValidatePickupData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1Sale) contextValidateReturnData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAutoRentalV1Sale) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAutoRentalV1Sale) UnmarshalBinary(b []byte) error {
	var res POSTAutoRentalV1Sale
