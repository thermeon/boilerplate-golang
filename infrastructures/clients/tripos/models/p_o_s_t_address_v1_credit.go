...
// POSTAddressV1Credit Address
//
// swagger:model POST_Address_v1_credit
type POSTAddressV1Credit struct {
...
// Validate validates this p o s t address v1 credit
func (m *POSTAddressV1Credit) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 credit based on context it is used
func (m *POSTAddressV1Credit) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1Credit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1Credit) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1Credit
