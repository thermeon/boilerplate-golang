...
// POSTReturnRequestV1ReturnTransactionIDPaymentType ReturnRequest
//
// swagger:model POST_ReturnRequest_v1_return_transactionId_paymentType
type POSTReturnRequestV1ReturnTransactionIDPaymentType struct {

	// The cardholder address information for the transaction.
	Address *POSTAddressV1ReturnTransactionIDPaymentType `json:"address,omitempty"`
	...
	Configuration *POSTReturnRequestConfigurationV1ReturnTransactionIDPaymentType `json:"configuration,omitempty"`
	...
	StoreCard *POSTStoreCardV1ReturnTransactionIDPaymentType `json:"storeCard,omitempty"`
...
// Validate validates this p o s t return request v1 return transaction Id payment type
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) validateAddress(formats strfmt.Registry) error {
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) validateStoreCard(formats strfmt.Registry) error {
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t return request v1 return transaction Id payment type based on the context it is used
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTReturnRequestV1ReturnTransactionIDPaymentType) UnmarshalBinary(b []byte) error {
	var res POSTReturnRequestV1ReturnTransactionIDPaymentType
