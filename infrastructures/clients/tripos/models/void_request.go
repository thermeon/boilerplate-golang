...
// Validate validates this void request
func (m *VoidRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VoidRequest) validateConfiguration(formats strfmt.Registry) error {
...
func (m *VoidRequest) validateLaneID(formats strfmt.Registry) error {
...
// ContextValidate validate this void request based on the context it is used
func (m *VoidRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *VoidRequest) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VoidRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VoidRequest) UnmarshalBinary(b []byte) error {
	var res VoidRequest
