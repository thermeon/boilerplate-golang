...
// UnloadGiftRequest UnloadGiftRequest
//
// swagger:model UnloadGiftRequest
type UnloadGiftRequest struct {
...
// Validate validates this unload gift request
func (m *UnloadGiftRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UnloadGiftRequest) validateConfiguration(formats strfmt.Registry) error {
...
func (m *UnloadGiftRequest) validateLaneID(formats strfmt.Registry) error {
...
func (m *UnloadGiftRequest) validateStoreCard(formats strfmt.Registry) error {
...
func (m *UnloadGiftRequest) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this unload gift request based on the context it is used
func (m *UnloadGiftRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UnloadGiftRequest) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnloadGiftRequest) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnloadGiftRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UnloadGiftRequest) UnmarshalBinary(b []byte) error {
	var res UnloadGiftRequest
