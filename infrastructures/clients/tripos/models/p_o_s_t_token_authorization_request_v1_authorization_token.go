...
// POSTTokenAuthorizationRequestV1AuthorizationToken TokenAuthorizationRequest
//
// swagger:model POST_TokenAuthorizationRequest_v1_authorization_token
type POSTTokenAuthorizationRequestV1AuthorizationToken struct {

	// The cardholder address information for the transaction.
	Address *POSTAddressV1AuthorizationToken `json:"address,omitempty"`
	...
	AutoRental *POSTAutoRentalBasicV1AuthorizationToken `json:"autoRental,omitempty"`
	...
	Configuration *POSTRequestConfigurationV1AuthorizationToken `json:"configuration,omitempty"`
	...
	Healthcare *POSTHealthcareV1AuthorizationToken `json:"healthcare,omitempty"`
...
// Validate validates this p o s t token authorization request v1 authorization token
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateAddress(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateAutoRental(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateCardLogo(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateHealthcare(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateTokenID(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateTokenProvider(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateTransactionAmount(formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) validateVaultID(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t token authorization request v1 authorization token based on the context it is used
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) contextValidateAutoRental(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) contextValidateHealthcare(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTTokenAuthorizationRequestV1AuthorizationToken) UnmarshalBinary(b []byte) error {
	var res POSTTokenAuthorizationRequestV1AuthorizationToken
