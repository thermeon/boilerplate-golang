...
// CloseGiftRequest CloseGiftRequest
//
// swagger:model CloseGiftRequest
type CloseGiftRequest struct {
...
// Validate validates this close gift request
func (m *CloseGiftRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloseGiftRequest) validateConfiguration(formats strfmt.Registry) error {
...
func (m *CloseGiftRequest) validateLaneID(formats strfmt.Registry) error {
...
func (m *CloseGiftRequest) validateStoreCard(formats strfmt.Registry) error {
...
func (m *CloseGiftRequest) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this close gift request based on the context it is used
func (m *CloseGiftRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CloseGiftRequest) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloseGiftRequest) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloseGiftRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CloseGiftRequest) UnmarshalBinary(b []byte) error {
	var res CloseGiftRequest
