...
// POSTActivateGiftRequestV1GiftActivate ActivateGiftRequest
//
// swagger:model POST_ActivateGiftRequest_v1_gift_activate
type POSTActivateGiftRequestV1GiftActivate struct {
...
// Validate validates this p o s t activate gift request v1 gift activate
func (m *POSTActivateGiftRequestV1GiftActivate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTActivateGiftRequestV1GiftActivate) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTActivateGiftRequestV1GiftActivate) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTActivateGiftRequestV1GiftActivate) validateStoreCard(formats strfmt.Registry) error {
...
func (m *POSTActivateGiftRequestV1GiftActivate) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t activate gift request v1 gift activate based on the context it is used
func (m *POSTActivateGiftRequestV1GiftActivate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTActivateGiftRequestV1GiftActivate) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTActivateGiftRequestV1GiftActivate) contextValidateStoreCard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTActivateGiftRequestV1GiftActivate) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTActivateGiftRequestV1GiftActivate) UnmarshalBinary(b []byte) error {
	var res POSTActivateGiftRequestV1GiftActivate
