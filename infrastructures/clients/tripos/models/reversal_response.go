...
type ReversalResponse struct {
	...
	// Original card payment type: Credit, Debit, Gift, EBT
...
func (m *ReversalResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ReversalResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *ReversalResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *ReversalResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this reversal response based on the context it is used
...
func (m *ReversalResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReversalResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReversalResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReversalResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
