...
// Validate validates this return response
func (m *ReturnResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ReturnResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *ReturnResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *ReturnResponse) validateWarnings(formats strfmt.Registry) error {
...
func (m *ReturnResponse) validateSignature(formats strfmt.Registry) error {
...
// ContextValidate validate this return response based on the context it is used
func (m *ReturnResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnResponse) contextValidateSignature(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ReturnResponse) UnmarshalBinary(b []byte) error {
