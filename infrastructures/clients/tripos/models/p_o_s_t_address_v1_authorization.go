...
// POSTAddressV1Authorization Address
//
// swagger:model POST_Address_v1_authorization
type POSTAddressV1Authorization struct {
...
// Validate validates this p o s t address v1 authorization
func (m *POSTAddressV1Authorization) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 authorization based on context it is used
func (m *POSTAddressV1Authorization) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1Authorization) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1Authorization) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1Authorization
