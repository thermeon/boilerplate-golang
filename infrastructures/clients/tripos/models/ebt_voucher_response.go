...
// EbtVoucherResponse EbtVoucherResponse
//
// swagger:model EbtVoucherResponse
type EbtVoucherResponse struct {
...
// Validate validates this ebt voucher response
func (m *EbtVoucherResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EbtVoucherResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) validateWarnings(formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) validateSignature(formats strfmt.Registry) error {
...
// ContextValidate validate this ebt voucher response based on the context it is used
func (m *EbtVoucherResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EbtVoucherResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) contextValidateSignature(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EbtVoucherResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EbtVoucherResponse) UnmarshalBinary(b []byte) error {
	var res EbtVoucherResponse
