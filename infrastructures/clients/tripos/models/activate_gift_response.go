...
// ActivateGiftResponse ActivateGiftResponse
//
// swagger:model ActivateGiftResponse
type ActivateGiftResponse struct {
...
// Validate validates this activate gift response
func (m *ActivateGiftResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ActivateGiftResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ActivateGiftResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *ActivateGiftResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *ActivateGiftResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this activate gift response based on the context it is used
func (m *ActivateGiftResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ActivateGiftResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActivateGiftResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActivateGiftResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActivateGiftResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActivateGiftResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ActivateGiftResponse) UnmarshalBinary(b []byte) error {
	var res ActivateGiftResponse
