...
// ReloadGiftResponse ReloadGiftResponse
//
// swagger:model ReloadGiftResponse
type ReloadGiftResponse struct {
...
// Validate validates this reload gift response
func (m *ReloadGiftResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReloadGiftResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ReloadGiftResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *ReloadGiftResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *ReloadGiftResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this reload gift response based on the context it is used
func (m *ReloadGiftResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReloadGiftResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReloadGiftResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReloadGiftResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReloadGiftResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReloadGiftResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ReloadGiftResponse) UnmarshalBinary(b []byte) error {
	var res ReloadGiftResponse
