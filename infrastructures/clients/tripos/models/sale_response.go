...
type SaleResponse struct {
	...
	DebitSurchargeAmount float64 `json:"debitSurchargeAmount,omitempty"`
	...
	// Indicates whether the Credit card Sale transaction converted to a PINless Debit Card transaction.
...
// Validate validates this sale response
func (m *SaleResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SaleResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *SaleResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *SaleResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *SaleResponse) validateWarnings(formats strfmt.Registry) error {
...
func (m *SaleResponse) validateEmv(formats strfmt.Registry) error {
...
func (m *SaleResponse) validateNonFinancialData(formats strfmt.Registry) error {
...
func (m *SaleResponse) validateSignature(formats strfmt.Registry) error {
...
// ContextValidate validate this sale response based on the context it is used
func (m *SaleResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SaleResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SaleResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SaleResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SaleResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SaleResponse) contextValidateEmv(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SaleResponse) contextValidateNonFinancialData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SaleResponse) contextValidateSignature(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SaleResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SaleResponse) UnmarshalBinary(b []byte) error {
	var res SaleResponse
