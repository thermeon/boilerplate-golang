...
type InputResponse struct {
	...
	CardholderAction string `json:"cardholderAction,omitempty"`

	// The raw, unformatted text that the cardholder entered into the input field on the PIN pad.
	InputText string `json:"inputText,omitempty"`
}

// Validate validates this input response
func (m *InputResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InputResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *InputResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *InputResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this input response based on the context it is used
func (m *InputResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InputResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InputResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InputResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InputResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InputResponse) UnmarshalBinary(b []byte) error {
