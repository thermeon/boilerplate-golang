...
// GETAutoRentalV1Force AutoRental
//
// swagger:model GET_AutoRental_v1_force
type GETAutoRentalV1Force struct {

	// Data related to any auto rental adjustments.
	AdjustmentData *GETAutoRentalAdjustmentDataV1Force `json:"adjustmentData,omitempty"`
	...
	PickupData *GETAutoRentalPickupDataV1Force `json:"pickupData,omitempty"`

	// Data related to autorental return.
	ReturnData *GETAutoRentalReturnDataV1Force `json:"returnData,omitempty"`
...
// Validate validates this g e t auto rental v1 force
func (m *GETAutoRentalV1Force) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GETAutoRentalV1Force) validateAdjustmentData(formats strfmt.Registry) error {
...
func (m *GETAutoRentalV1Force) validatePickupData(formats strfmt.Registry) error {
...
func (m *GETAutoRentalV1Force) validateReturnData(formats strfmt.Registry) error {
...
// ContextValidate validate this g e t auto rental v1 force based on the context it is used
func (m *GETAutoRentalV1Force) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GETAutoRentalV1Force) contextValidateAdjustmentData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GETAutoRentalV1Force) contextValidatePickupData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GETAutoRentalV1Force) contextValidateReturnData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GETAutoRentalV1Force) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GETAutoRentalV1Force) UnmarshalBinary(b []byte) error {
	var res GETAutoRentalV1Force
