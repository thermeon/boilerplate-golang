...
// Validate validates this gift request
func (m *GiftRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GiftRequest) validateAcceptorID(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateAccountID(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateAccountToken(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateApplicationID(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateApplicationName(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateApplicationVersion(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateAuthorizationSignature(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateCtafObject(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateLaneLock(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateRequestID(formats strfmt.Registry) error {
...
func (m *GiftRequest) validateRequestIDAsGUID(formats strfmt.Registry) error {
...
// ContextValidate validate this gift request based on the context it is used
func (m *GiftRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GiftRequest) contextValidateLaneLock(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GiftRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GiftRequest) UnmarshalBinary(b []byte) error {
	var res GiftRequest
