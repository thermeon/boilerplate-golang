...
//
// swagger:model TokenSaleResponse
...
// Validate validates this token sale response
func (m *TokenSaleResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TokenSaleResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *TokenSaleResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *TokenSaleResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *TokenSaleResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this token sale response based on the context it is used
func (m *TokenSaleResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TokenSaleResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenSaleResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TokenSaleResponse) UnmarshalBinary(b []byte) error {
	var res TokenSaleResponse
