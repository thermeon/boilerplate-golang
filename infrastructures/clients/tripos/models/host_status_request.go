...
// HostStatusRequest HostStatusRequest
//
// swagger:model HostStatusRequest
...
// Validate validates this host status request
func (m *HostStatusRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HostStatusRequest) validateAcceptorID(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateAccountID(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateAccountToken(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateApplicationID(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateApplicationName(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateApplicationVersion(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateAuthorizationSignature(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateCtafObject(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateLaneLock(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateRequestID(formats strfmt.Registry) error {
...
func (m *HostStatusRequest) validateRequestIDAsGUID(formats strfmt.Registry) error {
...
// ContextValidate validate this host status request based on the context it is used
func (m *HostStatusRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HostStatusRequest) contextValidateLaneLock(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostStatusRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HostStatusRequest) UnmarshalBinary(b []byte) error {
	var res HostStatusRequest
