...
//
// swagger:model HostStatusResponse
...
// Validate validates this host status response
func (m *HostStatusResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HostStatusResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *HostStatusResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *HostStatusResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *HostStatusResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this host status response based on the context it is used
func (m *HostStatusResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HostStatusResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostStatusResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostStatusResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostStatusResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostStatusResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HostStatusResponse) UnmarshalBinary(b []byte) error {
	var res HostStatusResponse
