...
// Validate validates this display response
func (m *DisplayResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DisplayResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DisplayResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *DisplayResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this display response based on the context it is used
func (m *DisplayResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DisplayResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DisplayResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DisplayResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DisplayResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DisplayResponse) UnmarshalBinary(b []byte) error {
	var res DisplayResponse
