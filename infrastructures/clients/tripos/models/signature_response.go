...
func (m *SignatureResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *SignatureResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *SignatureResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this signature response based on the context it is used
...
func (m *SignatureResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SignatureResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SignatureResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
