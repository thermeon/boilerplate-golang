...
// POSTAddressV1AuthorizationToken Address
//
// swagger:model POST_Address_v1_authorization_token
type POSTAddressV1AuthorizationToken struct {
...
// Validate validates this p o s t address v1 authorization token
func (m *POSTAddressV1AuthorizationToken) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 authorization token based on context it is used
func (m *POSTAddressV1AuthorizationToken) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1AuthorizationToken) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1AuthorizationToken) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1AuthorizationToken
