...
// POSTAddressV1Refund Address
//
// swagger:model POST_Address_v1_refund
type POSTAddressV1Refund struct {
...
// Validate validates this p o s t address v1 refund
func (m *POSTAddressV1Refund) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 refund based on context it is used
func (m *POSTAddressV1Refund) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1Refund) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1Refund) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1Refund
