...
type VoidResponse struct {
	...
	// The Account Number returned by the host
...
// Validate validates this void response
func (m *VoidResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VoidResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *VoidResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *VoidResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *VoidResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this void response based on the context it is used
func (m *VoidResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *VoidResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VoidResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VoidResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VoidResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VoidResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VoidResponse) UnmarshalBinary(b []byte) error {
