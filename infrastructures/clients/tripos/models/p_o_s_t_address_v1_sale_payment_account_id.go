...
// POSTAddressV1SalePaymentAccountID Address
//
// swagger:model POST_Address_v1_sale_paymentAccountId
type POSTAddressV1SalePaymentAccountID struct {
...
// Validate validates this p o s t address v1 sale payment account Id
func (m *POSTAddressV1SalePaymentAccountID) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 sale payment account Id based on context it is used
func (m *POSTAddressV1SalePaymentAccountID) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1SalePaymentAccountID) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1SalePaymentAccountID) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1SalePaymentAccountID
