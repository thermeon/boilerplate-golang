...
// BalanceTransferGiftResponse BalanceTransferGiftResponse
//
// swagger:model BalanceTransferGiftResponse
type BalanceTransferGiftResponse struct {
...
// Validate validates this balance transfer gift response
func (m *BalanceTransferGiftResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BalanceTransferGiftResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this balance transfer gift response based on the context it is used
func (m *BalanceTransferGiftResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BalanceTransferGiftResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BalanceTransferGiftResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BalanceTransferGiftResponse) UnmarshalBinary(b []byte) error {
	var res BalanceTransferGiftResponse
