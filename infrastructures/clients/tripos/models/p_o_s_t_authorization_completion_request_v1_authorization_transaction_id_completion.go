...
// POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion AuthorizationCompletionRequest
//
// swagger:model POST_AuthorizationCompletionRequest_v1_authorization_transactionId_completion
type POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion struct {
...
// Validate validates this p o s t authorization completion request v1 authorization transaction Id completion
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) validateAddress(formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) validateAutoRental(formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) validateConfiguration(formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) validateLaneID(formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) validateLodging(formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) validateTransactionAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this p o s t authorization completion request v1 authorization transaction Id completion based on the context it is used
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) contextValidateAutoRental(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) contextValidateLodging(ctx context.Context, formats strfmt.Registry) error {
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion) UnmarshalBinary(b []byte) error {
	var res POSTAuthorizationCompletionRequestV1AuthorizationTransactionIDCompletion
