...
// CloseGiftResponse CloseGiftResponse
//
// swagger:model CloseGiftResponse
type CloseGiftResponse struct {
...
// Validate validates this close gift response
func (m *CloseGiftResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloseGiftResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CloseGiftResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *CloseGiftResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *CloseGiftResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this close gift response based on the context it is used
func (m *CloseGiftResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CloseGiftResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloseGiftResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloseGiftResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloseGiftResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloseGiftResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CloseGiftResponse) UnmarshalBinary(b []byte) error {
	var res CloseGiftResponse
