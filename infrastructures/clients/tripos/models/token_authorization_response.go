...
//
// swagger:model TokenAuthorizationResponse
...
// Validate validates this token authorization response
func (m *TokenAuthorizationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TokenAuthorizationResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationResponse) validateProcessor(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationResponse) validateWarnings(formats strfmt.Registry) error {
...
// ContextValidate validate this token authorization response based on the context it is used
func (m *TokenAuthorizationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TokenAuthorizationResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationResponse) contextValidateProcessor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationResponse) contextValidateWarnings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TokenAuthorizationResponse) UnmarshalBinary(b []byte) error {
	var res TokenAuthorizationResponse
