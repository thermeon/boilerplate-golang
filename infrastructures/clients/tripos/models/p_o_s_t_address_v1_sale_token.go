...
// POSTAddressV1SaleToken Address
//
// swagger:model POST_Address_v1_sale_token
type POSTAddressV1SaleToken struct {
...
// Validate validates this p o s t address v1 sale token
func (m *POSTAddressV1SaleToken) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 sale token based on context it is used
func (m *POSTAddressV1SaleToken) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1SaleToken) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1SaleToken) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1SaleToken
