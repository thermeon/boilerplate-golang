...
//
// swagger:model TokenAuthorizationRequest
...
// Validate validates this token authorization request
func (m *TokenAuthorizationRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TokenAuthorizationRequest) validateAddress(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateAutoRental(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateCardLogo(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateConfiguration(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateHealthcare(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateLaneID(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateTokenID(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateTokenProvider(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateTransactionAmount(formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) validateVaultID(formats strfmt.Registry) error {
...
// ContextValidate validate this token authorization request based on the context it is used
func (m *TokenAuthorizationRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TokenAuthorizationRequest) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) contextValidateAutoRental(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) contextValidateConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) contextValidateHealthcare(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenAuthorizationRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TokenAuthorizationRequest) UnmarshalBinary(b []byte) error {
	var res TokenAuthorizationRequest
