...
// POSTAddressV1ReturnTransactionIDPaymentType Address
//
// swagger:model POST_Address_v1_return_transactionId_paymentType
type POSTAddressV1ReturnTransactionIDPaymentType struct {
...
// Validate validates this p o s t address v1 return transaction Id payment type
func (m *POSTAddressV1ReturnTransactionIDPaymentType) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this p o s t address v1 return transaction Id payment type based on context it is used
func (m *POSTAddressV1ReturnTransactionIDPaymentType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *POSTAddressV1ReturnTransactionIDPaymentType) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *POSTAddressV1ReturnTransactionIDPaymentType) UnmarshalBinary(b []byte) error {
	var res POSTAddressV1ReturnTransactionIDPaymentType
